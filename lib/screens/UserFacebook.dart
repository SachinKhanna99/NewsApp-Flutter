...
class UserFacebook extends StatefulWidget {
  final String name;
  UserFacebook(this.name);

  @override
  UserFacebookState createState() => UserFacebookState();
}

class UserFacebookState extends State<UserFacebook> {
  bool change = true;
  ...
  Widget build(BuildContext context) {
    TextEditingController username =
        new TextEditingController(text: widget.name.toString());
    _printLatestValue() {
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Navigator.of(context).pushAndRemoveUntil(new MaterialPageRoute(builder: (context) => new MainScreen(),), (route) => false);
                          ...
                          //           context,
                          //           MaterialPageRoute(
                          //               builder: (context) => UserDetails2(change
                          ...
                          //           MaterialPageRoute(
                          //               builder: (context) => UserDetails2(change
                          //                   ? username.text.toString().substring(0,10)
                          //                   : nname.text.toString().substring(0,10)
                          //               )
                          //           ),
                          //         );
                          //       }
      ...
      children: [
        ...
        Container(
          child: Text(
            "Welcome To,",
            style: TextStyle(
                color: Colors.white, fontSize: 25.0, fontFamily: 'roboto'),
          ),
        ),
        SizedBox(
        ...
        Container(
          child: Text(
            "Kailer",
            style: TextStyle(
                color: Colors.white, fontSize: 29.0, fontFamily: 'roboto'),
          ),
        ),
      ],
    );
